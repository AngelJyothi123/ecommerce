...
const Footer = () => {
  return (
    <footer className="mt-20 border-t border-white/10 bg-black/40 backdrop-blur-2xl text-white">
      <div className="max-w-7xl mx-auto px-6 py-16">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-12">
          <div className="col-span-1 md:col-span-2">
            <h3 className="text-2xl font-bold bg-clip-text text-transparent bg-gradient-to-r from-violet-400 to-fuchsia-400 mb-6 flex items-center">
            ...
            <p className="text-gray-400 mb-6 leading-relaxed max-w-sm">
              Your one-stop destination for premium electronics and fashion. Impeccable taste, unmatched quality.
            </p>
          ...
          <div>
            ...
            <ul className="space-y-3 text-gray-400">
              ...
              <li><Link to="/products/1" className="hover:text-fuchsia-400 transition-colors">Explore</Link></li>
              <li><Link to="/cart" className="hover:text-fuchsia-400 transition-colors">Your Cart</Link></li>
              <li><Link to="/orders" className="hover:text-fuchsia-400 transition-colors">Track Orders</Link></li>
            </ul>
          </div>
          <div>
            ...
            <ul className="space-y-4 text-gray-400">
              ...
              <li className="flex items-start">
                <div className="w-8 h-8 rounded-full bg-white/5 flex items-center justify-center mr-3 shrink-0">
                  <svg className="w-4 h-4 text-violet-400" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M17.657 16.657L13.414 20.9a1.998 1.998 0 01-2.827 0l-4.244-4.243a8 8 0 1111.314 0z"/><path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M15 11a3 3 0 11-6 0 3 3 0 016 0z"/></svg>
                </div>
                <span className="mt-1">123 Commerce St, Cyber City, NX 12345</span>
              </li>
            </ul>
          </div>
        </div>
        <div className="border-t border-white/5 mt-12 pt-8 text-center text-gray-500 text-sm">
          <p>&copy; {new Date().getFullYear()} ShopHub Premium. All rights reserved.</p>
        </div>
      </div>
    </footer>
  );
